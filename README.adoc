...
:experimental:
:url-github: https://github.com/hyperpolymath/valence-shell
:url-gitlab: https://gitlab.com/hyperpolymath/valence-shell
:url-bitbucket: https://bitbucket.org/hyperpolymath/valence-shell
:url-codeberg: https://codeberg.org/hyperpolymath/valence-shell
...
valence-shell is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
